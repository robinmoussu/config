...
" Local config {
    ...
    " Use bundles config {
        " select the bundle that will be install
        let g:spf13_bundle_groups=['general', 'neocomplcache', 'programming', 'misc', 'latex']
...
" Key (re)Mappings {
    ...
    nnoremap <Leader>rr :w<CR> :source ~/.vimrc <CR>
    ...
    " Fx keys {
        ...
        nmap <F1><F1> :w<CR><Esc>
        nmap <F2><F1> :bd!
        nmap <F1><F2> :wqa <CR><Esc>
        nmap <F2><F2> :q<CR>

        imap <F1><F1> <Esc>:w<CR><Esc>
        imap <F2><F1> <Esc>:q!
        imap <F1><F2> <Esc>:wqa <CR><Esc>
        imap <F2><F2> <Esc>:q<CR>
        ...
        augroup robin_c
            ...
            autocmd Filetype c,cpp,h,hpp nnoremap <Leader>; mjA;<Esc>`j
            "make
            autocmd Filetype c,cpp,h,hpp noremap <F3> :wa <CR> :!clear <CR> :!make <CR>
            autocmd Filetype c,cpp,h,hpp noremap <F4> :wa <CR> :!make clean <CR>

            autocmd BufEnter *.h,*.hpp call g:HeaderguardAdd()
        augroup END


        augroup robin_txt
            autocmd!
            autocmd Filetype *.mkd source ~/.vimrcmkd
        augroup END
        " }
    " }
    ...
    " ————————————————
    "" Bugfixes for my broken keyboard
    "map ° %
    "map ¿ `
" }
        ...
        if count(g:spf13_bundle_groups, 'neocomplete')
            ...
            " Plugin key-mappings {
                ...
                if exists('g:spf13_noninvasive_completion')
                    ...
                    imap <silent><expr><C-t> neosnippet#expandable() ?
